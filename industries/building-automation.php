...
<head>
    <meta charset="utf-8">
    <title>Building Automation | Infinio Technology Solutions</title>
                        ...
                        <div class="col-12 text-center text-lg-start">
                            ...
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb justify-content-center justify-content-lg-start animated slideInLeft">
                                    ...
                                    <li class="breadcrumb-item text-white active" aria-current="page">Building Automation</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-12 wow zoomIn" data-wow-delay="0.2s">
                        <div class="rcorners2 position-relative row-card-ind p-4 ">
                            <div class="col-lg-6 wow fadeInUp mb-0" data-wow-delay="0.1s" style="visibility: visible; animation-delay: 0.1s; animation-name: fadeInUp;">
                                <img class="rounded img-fluid wow zoomIn" data-wow-delay="0.5s" src="../img/ba-card.jpg" style="visibility: visible; animation-delay: 0.5s; animation-name: zoomIn;">
                            </div>
                            <div class="col-lg-6 ">
