                    ...
                    <div class="col-lg-12 wow fadeInUp" data-wow-delay="0.1s">
                        ...
                        <div class="position-relative mb-4 pt-5">
                            ...
                            <ul>
                                ...
                                <li>Condos and associations</li>
                                <li>Assisted living residential</li>
                                <li>Commercial real estate management</li>
                                <li>Construction and development</li>
                                <li>Property management</li>
                                <li>Property maintenance and inspection</li>
                                <li>Property acquisition</li>
                                <li>Property investment</li>
                                <li>Foreclosure management</li>
                                <li>Rental and leasing management</li>
                                <li>Payment solutions</li>
                                <li>Facility management</li>
                                <li>Marketing automation</li>
                                <li>Accounting and finance management</li>
                                <li>Back office process management</li>
                                <li>Custom reporting tools and analytics</li>
                            </ul>
                        </div>
                    </div>
                    <!-- <div class="col-lg-5">
                    ...
                    <div class="col-sm-12 wow zoomIn" data-wow-delay="0.2s">
                        <div class="rcorners2 position-relative row-card-ind p-4 ">
                            <div class="col-lg-6 wow fadeInUp mb-0" data-wow-delay="0.1s"
                                ...
                                <img class="rounded img-fluid wow zoomIn" data-wow-delay="0.5s" src="../img/re-card.jpg"
                                    style="visibility: visible; animation-delay: 0.5s; animation-name: zoomIn;">
                            </div>
                            <div class="col-lg-6 ">
                                <!-- <h4 class="fw-bold mb-1">e-Governance</h4> -->
                                <p class="mb-0 para-justify py-4 px-4">As part of our services, we do design, coding,
                                    testing, system integration, and making sure the product will last. We assist in
                                    bridging the gap between real estate agents and potential clients.
                                </p>
