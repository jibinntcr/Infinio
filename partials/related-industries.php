...
<div class="container-xxl py-5">
    <div class="container px-lg-5">
        <div class="section-title position-relative text-center mx-auto mb-5 pb-4 wow fadeInUp" data-wow-delay="0.1s" style="max-width: 600px;">
            <h1 class="mb-3">RELATED INDUSTRIES</h1>
        </div>
        <div class="row g-3  position-relative">
            <div class="col-lg-6 ">
                <div class="row gy-3 gx-3 align-items-center">
                    ...
                    <div class="col-sm-12 wow zoomIn" data-wow-delay="0.2s">
                        <div class=" rcorners2 row-card-ind">
            ...
            <div class="position-relative text-center mx-auto mb-5 pb-4 wow fadeInUp" data-wow-delay="0.1s" style="max-width: 600px">
                <a href="index.php" class="text-black btn btn-secondary py-sm-3 px-sm-5 me-3 animated slideInLeft">Explore More</a>
            </div>
        </div>
    </div>
</div>
