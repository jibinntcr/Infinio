...
<head>
    <meta charset="utf-8">
    <title>Enterprise Software Development | Infinio Technology Solutions</title>
                        ...
                        <div class="col-12 text-center text-lg-start">
                            ...
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb justify-content-center justify-content-lg-start animated slideInLeft">
                                    ...
                                    <li class="breadcrumb-item text-white active" aria-current="page">Enterprise Software Development</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
        ...
        <div class="container-xxl py-5">
            <div class="container px-lg-5">
                <div class="row g-5 align-items-center">
                    ...
                    <div class="col-lg-5">
                        <img class="img-fluid wow zoomIn" data-wow-delay="0.5s" src="../img/ERP.png">
                    </div>
                </div>
            </div>
        </div>
