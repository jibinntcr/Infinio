...
<head>
    <meta charset="utf-8">
    <title>Learning Management System | Infinio Technology Solutions</title>
                        ...
                        <div class="col-12 text-center text-lg-start">
                            ...
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb justify-content-center justify-content-lg-start animated slideInLeft">
                                    ...
                                    <li class="breadcrumb-item text-white active" aria-current="page">Learning Management System</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
