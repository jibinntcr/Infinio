...
<body>
  <div class="container-xxl bg-white p-0">
    ...
    <div class="container-xxl py-5">
      <div class="container px-lg-5">
        ...
        <div class="position-relative text-center mx-auto mb-5 pb-4 wow fadeInUp" data-wow-delay="0.1s" style="max-width: 600px">
          <a href="services/services.php" class="text-black btn btn-secondary py-sm-3 px-sm-5 me-3 animated slideInLeft">Explore More</a>
        </div>
      </div>
    </div>
    <!-- Pricing End -->
    ...
    <div class="container-xxl py-5">
      <div class="container px-lg-5">
        ...
        <div class="position-relative text-center mx-auto mb-5 pb-4 wow fadeInUp" data-wow-delay="0.1s" style="max-width: 600px">
          <a href="industries/index.php" class="text-black btn btn-secondary py-sm-3 px-sm-5 me-3 animated slideInLeft">Explore More</a>
        </div>
      </div>
    </div>
    <!--INDUSTRIES  END-->
  ...
  <script src="//code.tidio.co/ldilk5dfmig0ir5b5k6rj1mz0rsye6x6.js" async></script>
