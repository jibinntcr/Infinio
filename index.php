    ...
    <div class="container-xxl bg-white p-0">
        ...
        <div class="container-xxl position-relative p-0">
            <nav class="navbar navbar-expand-lg navbar-light px-4 px-lg-5 py-3 py-lg-0">
                <a href="./index.php" class="navbar-brand p-0">
                    <h1 class="m-0">
                        <!--<i class="fa fa-server me-3"></i>Infinio Technologies</h1>-->
                    ...
                    <div class="navbar-nav ms-auto py-0">
                        <div class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu m-0">
                                ...
                                <a href="services/custom-application-development.php" class="dropdown-item">Custom
                                    Software Application Development</a>
                                ...
                                <a href="services/mobile-application-development.php" class="dropdown-item">Mobile
                ...
                <div class="container my-5 py-5 px-lg-5">
                    <div class="row g-5">
                        <div class="col-lg-6 pt-5 text-center text-lg-start">
                            ...
                            <a href="#startDiv" class="btn btn-secondary py-sm-3 px-sm-5 me-3 animated slideInLeft">Get
                                Started Now</a>
                        </div>
            ...
            elitr sit clita.
                    ...
                    <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.2s">
                        <div class="position-relative shadow rounded border-top border-5 border-primary">
                            ...
                            <div class="text-center border-bottom p-4">
                                ...
                                <a class="btn btn-primary px-4 py-2" href="services/web-application-dev.php">Read
                                    More</a>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="position-relative shadow rounded border-top border-5 border-primary">
                            ...
                            <div class="text-center border-bottom p-4">
                                ...
                                <a class="btn btn-primary px-4 py-2"
                                    href="services/enterprise-application-development-services.php">Read More</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6 wow fadeInUp mb-5" data-wow-delay="0.6s">
                        <div class="position-relative shadow rounded border-top border-5 border-primary">
                            ...
                            <div class="text-center border-bottom p-4">
                                ...
                                <a class="btn btn-primary px-4 py-2"
                                    href="services/custom-application-development.php">Read More</a>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="position-relative text-center mx-auto mb-5 pb-4 wow fadeInUp" data-wow-delay="0.1s"
                    ...
                    <a href="services/services.php"
                        class="text-black btn btn-secondary py-sm-3 px-sm-5 me-3 animated slideInLeft">Explore More</a>
                </div>
            </div>
        </div>
        <!-- Pricing End -->
        ...
        <div class="container-xxl py-5">
            <div class="container px-lg-5">
                <div class="section-title position-relative text-center mx-auto mb-5 pb-4 wow fadeInUp"
                    data-wow-delay="0.1s" style="max-width: 600px">
                    <h1 class="mb-3">CORE TECHNOLOGIES</h1>
                </div>
                    ...
                    <div class="row wow fadeInUp" data-wow-delay="0.1s">
                        <div class="col-lg-12">
                            ...
                            <ul class="nav nav-tabs" id="argoTabs" role="tablist">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" id="nav-tab-3" data-toggle="tab" href="#tab-3" role="tab"
                                        ...
                                        <i class="fas fa-server"></i>Database</a>
                                </li>
                            </ul>
                            <!-- end of tabs links -->
                            ...
                            <div class="tab-content" id="argoTabsContent">
                                            ...
                                            <div class="row g-5 comparison position-relative">
                                                <div class="col-lg-6 pe-lg-5">
                                                    <!--<div class="section-title position-relative mx-auto mb-4 pb-4">
                                                            <h3 class="fw-bold mb-0">Back End</h3>
                                                        </div>-->
                                                    <div class="row gy-3 gx-5">
                                                        <img src="img/web-backend.jpg" />
                                                    </div>
                                                </div>
                                                <div class="col-lg-6 ps-lg-5">
                                                    <!--<div class="section-title position-relative mx-auto mb-4 pb-4">
                                                            <h3 class="fw-bold mb-0">Front End</h3>
                                                        </div>-->
                                                    <div class="row gy-3 gx-5">
                                                        <img src="img/web-frontend.jpg" />
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <!-- Tab -->
                                <div class="tab-pane fade" id="tab-3" role="" aria-labelledby="tab-3">
                                    <div class="container-xxl py-5">
                                        <div class="container px-lg-5">
                                            <div class="row g-5 position-relative">
                                                <div class="col-lg-6 pe-lg-5">
                        ...
                        <div class="row gy-5 g-4">
                            <div class="col-md-6">
                                ...
                                <a class="btn btn-link"
                                    href="services/enterprise-application-development-services.php">Enterprices
                                    Application Development</a>
                                <a class="btn btn-link" href="services/custom-application-development.php">Custom
                                    Software Application Development</a>
                                ...
                                <a class="btn btn-link" href="services/mobile-application-development.php">Mobile
                                    Application Development</a>
                                <a class="btn btn-link" href="services/learning-management-system.php">Learning
                                    Management System</a>
                            ...
                            <div class="col-md-6">
                                ...
                                <a class="btn btn-link" href="industries/retail-and-ecommerce.php">Retail and
                                    E-commerce</a>
